...
class Cube:
	def __init__(self, gr_from, gr_to, ws_from, ws_to, pb_from, pb_to):
		self.gr_from = Decimal(gr_from).quantize(Decimal('1.00'))
		self.gr_to = Decimal(gr_to).quantize(Decimal('1.00'))
	...
	def __eq__(self, other):
		return abs(self.gr_from-other.gr_from) < 0.001 and abs(self.gr_to-other.gr_to) < 0.001 and abs(self.ws_from-other.ws_from) < 0.001 and abs(self.ws_to-other.ws_to) < 0.001 and abs(self.pb_from-other.pb_from) < 0.001 and abs(self.pb_to-other.pb_to) < 0.001
