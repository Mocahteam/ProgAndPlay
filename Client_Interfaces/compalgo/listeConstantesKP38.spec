--
-- listeConstantesKP38.spec
-- liste des constantes valides pour intéragir avec les unités System du mod
-- Kernel_Panic 3.8 compatible avec le moteur Spring
--
...
constante POINTER <Entier> = 37;
constante SIGNAL <Entier> = 40;
constante SOCKET <Entier> = 41;
constante TERMINAL <Entier> = 42;
