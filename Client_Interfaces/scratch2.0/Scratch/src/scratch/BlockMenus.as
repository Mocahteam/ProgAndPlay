...
public class BlockMenus implements DragClient {
	...
	public static function BlockMenuHandler(evt:MouseEvent, block:Block, blockArg:BlockArg = null, menuName:String = null):void {
		...
		if (menuName == 'commandsOnPosition')  menuHandler.commandsOnPositionMenu(evt);
		if (menuName == 'commandsOnUnit')  menuHandler.commandsOnUnitMenu(evt);
		if (menuName == 'states')  menuHandler.statesMenu(evt);
		if (menuName == 'commandsUntarget')  menuHandler.commandsUntargetMenu(evt);
		// ---
	}
...
//			handler.scrollAlignMenu(evt);
			...
			handler.commandsOnUnitMenu(evt);
			handler.statesMenu(evt);
			handler.commandsUntargetMenu(evt);
			// ---
		}
		return [
