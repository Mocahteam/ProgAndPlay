...
public class Specs {
	...
	public static var commands:Array = [
		...
		["amount of %m.resource resource",				"r", 13, "helloWorld", "METAL"],
		["number of unit in %m.coalition coalition",	"r", 13, "helloWorld", "MY"],
		["unit %n of %m.coalition coalition",			"r", 13, "helloWorld", 0, "MY"],
		["--"],
